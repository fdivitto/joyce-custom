...
UiMenuBarCommand::UiMenuBarCommand(SDLKey k, string caption, UiDrawer *d) :
		UiCommand(k, caption,d)
{
}

UiMenuBarCommand::~UiMenuBarCommand()
{
}

void UiMenuBarCommand::draw(int selected)
{
